...
const Messages: React.FC<{ conversationId: string }> = ({ conversationId }) => {
  ...
  const loadMessages = async () => {
    ...
    setLoading(true)
    try {
      const data = await GetMessagesByConversation(member.id, 'd74d64c7-bb1b-4046-9ce6-73a404d9ca3a')
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '600', color: '#fff', padding: 16, paddingTop: 48 },
  inputContainer: {
    flexDirection: 'row',
    padding: 12,
    borderTopWidth: 1,
